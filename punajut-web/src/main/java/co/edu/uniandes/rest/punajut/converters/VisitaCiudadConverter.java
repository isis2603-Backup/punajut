...
public abstract class VisitaCiudadConverter {
    ...
    private static VisitaCiudadEntity basicDTO2Entity(VisitaCiudadDTO dto) {
        if (dto != null) {
            ...
            //entity.setCiudad(CiudadConverter.refDTO2Entity(dto.getCiudad()));
            return entity;
        } else {
            return null;
        }
    ...
    public static VisitaCiudadDTO fullEntity2DTO(VisitaCiudadEntity entity) {
        if (entity != null) {
            VisitaCiudadDTO dto = basicEntity2DTO(entity);
    ...
    public static VisitaCiudadEntity fullDTO2Entity(VisitaCiudadDTO dto) {
        if (dto != null) {
            VisitaCiudadEntity entity = basicDTO2Entity(dto);
    ...
    /**
     * Convierte una colección de instancias de VisitaCiudadEntity a VisitaCiudadDTO. Para cada
     * instancia de VisitaCiudadEntity en la lista, invoca basicEntity2DTO y añade el
     * nuevo VisitaCiudadDTO a una nueva lista
     *
     ...
     * VisitaCiudadEntity Para cada instancia se invoca el método basicDTO2Entity
     *
