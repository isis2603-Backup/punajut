...
(function (ng) {
    ...
    var mod = ng.module('foroMock', ['ngMockE2E']);
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
         ...
         * ej: api/foro/1
         */
        var recordUrl = new RegExp('api/foro/([0-9]+)');
        ...
        var records = [{
                id: 1,
                username: 'Viajero0001',
                date: '2016-02-28',
                reply: 'Lorem ipsum ad his scripta blandit partiendo, eum fastidii accumsan euripidis in'
            }];
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/foro"
         ...
         */ 
        $httpBackend.whenGET('api/foro').respond(function (method, url) {
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud GET a la url "api/foro/[numero]"
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud POST a la url "api/foro"
         ...
         */
        $httpBackend.whenPOST('api/foro').respond(function (method, url, data) {
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud DELETE a la url "api/foro/[numero]"
        ...
        /*
         * Esta funcion se ejecuta al invocar una solicitud PUT a la url "api/foro/[numero]"
